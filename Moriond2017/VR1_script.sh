...
for i in 1 2 3
do
  supercutsLocation="regions_${version}/VR1-${i}.json"
  cutsLocation="${baseDir}/VR1${i}Cuts"

  #outputNMinus1="n-1/VR1-${i}"
  ...
  for lumi in 35
  do
    significancesLocation="${baseDir}/VR1${i}Significances_${lumi}"
    ...
    summaryLocation="${baseDir}/summary_VR1${i}_${lumi}.json"
