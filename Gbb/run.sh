...
# calculate significances with lumi = 6 ifb
python ../Optimization/optimize.py optimize --signal 37* \
    --bkgd $(cat bkgdFiles | sed "s/$/.json/g" | tr '\n' ' ') \
    -b --bkgdUncertainty=0.3 --bkgdStatUncertainty=0.3 --insignificance=2 --lumi 6
# produce the sig plot
python ../Optimization/slim_significances.py
python ../Optimization/graph-grid.py --lumi 6 --outfile plots \
...
python ../Optimization/graph-cuts.py --lumi 6 --outfile plots --sigdir significances \
